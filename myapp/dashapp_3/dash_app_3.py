...
from .models import get_wind_data, get_wind_data_by_id
...
def init_dashboard(server):
    ...
    @dash_app.callback(Output("wind-speed", "figure"), [Input("wind-speed-update", "n_intervals")])
    ...
    @dash_app.callback(Output("wind-direction", "figure"), [Input("wind-speed-update", "n_intervals")])
